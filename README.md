...
<i> <b>Note:</b> The plots do not have a transparent background, if this is needed, the </i> <b>bg = "transparent"</b> <i>attribute should be added to the </i> <code> png(file = "plotX.png", bg = "transparent") </code>
